...
public class GEConstant {
	...
	//ROTATE(8,toolkit.createCustomCursor(toolkit.getImage("rsc//RotateCursor.gif"), new Point(12,12), "rotate"));
	...
	public static Cursor RR_CURSOR		= toolkit.createCustomCursor(toolkit.getImage("rsc/RotateCursor.gif"), new Point(12,12), "rotate");
