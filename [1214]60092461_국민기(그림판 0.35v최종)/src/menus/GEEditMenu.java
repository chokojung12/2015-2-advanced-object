	...
	public void delete(){
		...
		for(GEShape shape : this.drawingPanel.getShapes()){
			if(shape == this.deleteShape){ 
				...
				temp = (Vector<GEShape>) this.drawingPanel.getShapes().clone();
				this.drawingPanel.getUndoStack().push(temp);
				System.out.println(this.drawingPanel.getUndoStack().getStack().size());*/
